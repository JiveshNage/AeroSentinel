...
export const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-surface flex flex-col font-sans">
      <Header systemHealthy={error ? false : (loading && !healthData ? null : isHealthy)} />
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-[0.75rem] font-mono text-muted">Feature F0 (Project Scaffold)</span>
              </div>
              ...
              <p className="text-[0.875rem] text-muted mt-1 max-w-3xl font-sans">
                End-to-end scaffold integrating FastAPI ingestion, TimescaleDB sensor hypertable,
                Redis state cache, rule engine, spatial consistency checker, and React operator console.
              </p>
            </div>
        ...
        <div className="bg-panel border border-line rounded p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="p-4 border border-line rounded bg-surface">
              ...
              <p className="text-[0.8125rem] text-muted mt-1 font-sans">
                Rule engine (range/step/flatline), ML anomaly scoring (IsolationForest/LSTM-AE), and KDTree spatial check.
              </p>
              <span className="inline-block mt-3 text-[0.6875rem] font-mono text-muted border border-line px-1.5 py-0.5 rounded">
                backend/qc
              </span>
